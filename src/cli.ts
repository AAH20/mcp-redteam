...
function printUsage(): void {
  console.error(
    [
      ...
      "                       over stdio. Also runs unauthenticated-tool-exposure,",
      "                       which makes a second, credential-free connection",
      "                       attempt to the same URL regardless of --header.",
      "  --header \"K: V\"      Header to send on the (non-exposure) HTTP connection.",
      "                       Repeatable.",
      "",
      "Examples:",
